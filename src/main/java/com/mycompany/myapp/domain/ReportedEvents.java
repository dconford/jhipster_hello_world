...
public class ReportedEvents implements Serializable {
    ...
    public CrimeCategoryData getCrimeCategoryData() {
        return crimeCategoryData;
    }

    public ReportedEvents crimeCategoryData(CrimeCategoryData crimeCategoryData) {
        this.crimeCategoryData = crimeCategoryData;
        return this;
    }

    public void setCrimeCategoryData(CrimeCategoryData crimeCategoryData) {
        this.crimeCategoryData = crimeCategoryData;
    }

    public NeighborhoodData getNeighborhoodData() {
        return neighborhoodData;
    }

    public ReportedEvents neighborhoodData(NeighborhoodData neighborhoodData) {
        this.neighborhoodData = neighborhoodData;
        return this;
    }

    public void setNeighborhoodData(NeighborhoodData neighborhoodData) {
        this.neighborhoodData = neighborhoodData;
    }

    public CodedDateData getCodedDateData() {
        return codedDateData;
    }

    public ReportedEvents codedDateData(CodedDateData codedDateData) {
        this.codedDateData = codedDateData;
        return this;
    }

    public void setCodedDateData(CodedDateData codedDateData) {
        this.codedDateData = codedDateData;
    }
