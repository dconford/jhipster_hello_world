...
export class ReportedEventsUpdateComponent implements OnInit {
  ...
  updateForm(reportedEvents: IReportedEvents): void {
    this.editForm.patchValue({
      ...
      crimeCategoryDataId: reportedEvents.crimeCategoryDataId,
      neighborhoodDataId: reportedEvents.neighborhoodDataId,
      codedDateDataId: reportedEvents.codedDateDataId
    });
  }
  ...
  private createFromForm(): IReportedEvents {
    return {
      ...
      crimeCategoryDataId: this.editForm.get(['crimeCategoryDataId'])!.value,
      neighborhoodDataId: this.editForm.get(['neighborhoodDataId'])!.value,
      codedDateDataId: this.editForm.get(['codedDateDataId'])!.value
    };
  }
