...
public class ReportedEventsResourceIT {
    ...
    @Autowired
    private ReportedEventsService reportedEventsService;
    ...
    public void setup() {
        ...
        final ReportedEventsResource reportedEventsResource = new ReportedEventsResource(reportedEventsService);
    ...
    public void createReportedEvents() throws Exception {
        ...
        ReportedEventsDTO reportedEventsDTO = reportedEventsMapper.toDto(reportedEvents);
        restReportedEventsMockMvc.perform(post("/api/reported-events")
            .contentType(TestUtil.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(reportedEventsDTO)))
    ...
    public void updateReportedEvents() throws Exception {
        ...
        updatedReportedEvents
            ...
            .crimeCategoryShortened(UPDATED_CRIME_CATEGORY_SHORTENED)
            .newDateField(UPDATED_NEW_DATE_FIELD);
        ReportedEventsDTO reportedEventsDTO = reportedEventsMapper.toDto(updatedReportedEvents);
